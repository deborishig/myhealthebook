                      ...
                      <tbody>
                        @foreach ($professions as $index => $profession)
                          <tr>
                            ...
                            <td>
                              <a href="{{ Request::url().'/'.$profession->id }}/edit" class="btn btn-xs btn-default"><i class="fa fa-edit"></i>Edit</a>
                              <a href="{{ Request::url().'/'.$profession->id }}/delete" class="btn btn-xs btn-default"><i class="fa fa-close"></i>Delete</a>
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
