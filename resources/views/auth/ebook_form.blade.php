            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="ebook_form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="{{ Request::url() . '/ebook_form_submit/'. ($ebook ? $ebook->id : '') }}">
                      @csrf
                    ...
                    <!-- <button class="btn btn-primary" type="reset">Reset</button> -->
                          <input type="submit" class="btn btn-success" value="{{ ($ebook) ? 'Update' : 'Add' }} Ebook" />
                        </div>
                      </div>
