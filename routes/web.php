...
Route::post('/professions/{pid}/delete', 'ProfessionController@deleteProfessions')->name('delete_prof');
...
// Route::get('/ebooks/ebook_form_submit/{eid?}', 'EbookController@ebookFormSubmit')->name('ebook_form_submit');
Route::post('/ebooks/ebook_form_submit/{eid?}', 'EbookController@ebookFormSubmit')->name('ebook_form_submit');
